...
public DefaultTableModel ListarDatos()
{
    ...
    try
    {
        ...
        result = sentencia.executeQuery("select * from Consultas");
...
public void Actualizar(int codigo, String Apellidos, String Nombre, String telefono)
{
        try
        {
            ...
            MyConexion = nuevaConexion.Conectar();
            Statement sentencia = MyConexion.createStatement();
            sentencia.executeQuery("Update Consultas set Apellidos ="+"'"+Apellidos+"',Nombres="+"'"+Nombre+"',Telefono="+"'"+telefono+"' where idEmpleados="+"'"+codigo+"'");
        }
    ...
    try
        {
            ...
            MyConexion = nuevaConexion.Conectar();
            Statement sentencia = MyConexion.createStatement();
            sentencia.executeQuery("Insert into Consultas values("+"'"+codigo+"',"+"'"+Apellidos+"',"+"'"+Nombres+"',"+"'"+Telefono+"')");
        }
        catch(SQLException ex)
        {
    ...
    try
        {
            ...
            MyConexion = nuevaConexion.Conectar();
            Statement sentencia = MyConexion.createStatement();
            sentencia.executeQuery("delete from Consultas where idEmpleados="+"'"+codigo+"'");
        }
            catch(SQLException ex)
        {
