...
public class EmpleadosController implements ActionListener, MouseListener{
 ...
 frmConsulta VistaConsultas;
 EmpleadosModel ModeloEmpleado;
 
    

    public EmpleadosController(frmEmpleados VistaEmpleados, frmPrincipal VistaPrincipal, EmpleadosModel ModeloEmpleado, frmConsulta VistaConsultas) {
      ...
      this.VistaPrincipal.menAdministrar.addActionListener(this);
      this.VistaPrincipal.menBuscar.addActionListener(this);
      ...
      /* LEVANTAR EL MODELO Y LOGRAR RECORRER EL RESULTSET*/
         // Captar el resultado que viene del Modelo desde el método LISTARDATOS
            ...
            this.VistaPrincipal.menAdministrar.addMouseListener(this);
            this.VistaPrincipal.menBuscar.addMouseListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == this.VistaConsultas.btnEjecutar)
        {
            DefaultTableModel TablaModelo2 = this.ModeloEmpleado.ListarDatosConsulta(this.VistaConsultas.txtConsulta.getText());
                this.VistaConsultas.tablaConsulta.setModel(TablaModelo2);
                
            this.VistaConsultas.txtConsulta.setText("");
        }
    ...
    public void mouseClicked(MouseEvent arg0) {
        ...
        if(arg0.getSource() == this.VistaPrincipal.menAdministrar)
        {
            this.VistaEmpleados.setLocationRelativeTo(null);
            this.VistaEmpleados.setVisible(true);
        }
        if(arg0.getSource() == this.VistaPrincipal.menBuscar)
        {
